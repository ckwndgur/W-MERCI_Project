...
public class EditAssessmentExtraFieldsAffectedAddresreferencesFragment extends PreferenceFragmentCompat implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        setPreferencesFromResource(R.xml.edit_assessment_extra_fields_affected_address_preferences, rootKey);
        context = getActivity();
        prefs = PreferenceManager.getDefaultSharedPreferences(context);
        middleware = new MERCIMiddleware(context);
        stateid = (ListPreference) findPreference(getString(R.string.individual_edit_assessment_affectedaddress__stateid_field));
        updateSummaries();
